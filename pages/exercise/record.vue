  ...
  <div class="record-wrap no-scrollbar">
    <div class="record-list" v-if="!pageLoading && recordList.length">
      <div class="list-item" v-for="(item, index) in recordList" :key="index">
        ...
        <div class="item-child" v-for="(childItem, childIndex) in item.practiceRecord" :key="childIndex" @click="toReport(childItem.id)">
          <div class="child-map">
            <map
          ...
          <div class="child-info">
            <div class="info-distance">
              {{ childItem.distance }}<text>Km</text>
            </div>
            <div class="info-time">
              {{ childItem.duration }}
            </div>
          ...
          <div class="child-btn">
            <image v-if="Number(childItem.isRecord) === 0" @click.stop="openSummarizePopup(childItem)" src="https://7072-prod-1gnzk6n75a8b6b8b-1327385705.tcb.qcloud.la/images/exercise/icon-edit.png?sign=345f0ea638667a885fea612325e8c2fe&t=1742297744" />
            <image v-else  src="https://7072-prod-1gnzk6n75a8b6b8b-1327385705.tcb.qcloud.la/images/exercise/icon-share.png?sign=345f0ea638667a885fea612325e8c2fe&t=1742297744" />
          </div>
        </div>
      </div>
    </div>
